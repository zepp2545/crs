<div class="tab-pane active">
    ...
    <li class="nav-item"><a class="nav-link active" href="#lesson" data-toggle="tab">Lesson</a></li>
    <li class="nav-item"><a class="nav-link" href="#lessonGroup" data-toggle="tab">Lesson Group</a></li>
    </ul>
